module test_jacobi
    ...
    public :: collect_jacobi_testsuite
    ...
    subroutine collect_jacobi_testsuite(testsuite)
        type(unittest_type), allocatable, intent(out) :: testsuite(:)

        testsuite = [ new_unittest("Manufactured solution for Jacobi", manufactured_solution_jacobi) ]

        return
    end subroutine collect_jacobi_testsuite

    subroutine manufactured_solution_jacobi(error)
        ...
        ! Jacobi solver.
        u = 0.0_dp ; call jacobi_solver(u, rhs, grid, residual, tol, maxiter)
    ...
    end subroutine manufactured_solution_jacobi

end module test_jacobi
